...
```mermaid
%%{init: {'theme':'dark', 'themeVariables': { 'fontSize':'14px', 'darkMode':'true', 'background':'#0d1116', 'clusterBkg':'#0d1116', 'clusterBorder':'#fff'}}}%%
graph TB
...
```mermaid
%%{init: {'theme':'dark', 'themeVariables': { 'fontSize':'16px', 'darkMode':'true', 'background':'#0d1116', 'clusterBkg':'#0d1116', 'clusterBorder':'#fff'}}}%%
erDiagram
...
```mermaid
%%{init: {'theme':'dark', 'themeVariables': { 'fontSize':'15px', 'darkMode':'true', 'background':'#0d1116', 'clusterBkg':'#0d1116', 'clusterBorder':'#fff'}}}%%
flowchart TD
