...
> **Your role:** You've proven yourself as a Gatekeeper. Now you help run server events and have more tools to keep the community healthy.
>
> **Prerequisites:** [GATEKEEPER-GUIDE.md](GATEKEEPER-GUIDE.md) — Make sure you're solid on the basics first.
...
| [GATEKEEPER-GUIDE.md](GATEKEEPER-GUIDE.md) | Previous tier (gate system basics) |
