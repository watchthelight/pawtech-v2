...
export const SAMPLE_ANSWERS_LONG: ReviewAnswer[] = [
  {
    q_index: 1,
    question: "What is your age?",
    answer: "I am 24 years old, turning 25 in a few months. I've been part of the furry community for about 6 years now.",
  },
  {
    q_index: 2,
    question: "How did you find this server?",
    answer: "A friend of mine recommended this server after I mentioned I was looking for a welcoming furry community. They showed me a post on Twitter about the server's art channels and events, which really caught my interest. I've also heard great things about the community culture here from other friends who are members.",
  },
  {
    q_index: 3,
    question: "What tend to be your goals here?",
    answer: "My main goals are to connect with other furry artists, share my digital artwork, participate in community events, and learn from more experienced artists. I'm particularly interested in improving my character design skills and exploring different art styles within the furry fandom. I also hope to make lasting friendships with people who share similar creative interests.",
  },
  {
    q_index: 4,
    question: "Have you read and agreed to follow our server rules?",
    answer: "Yes, I have carefully read through all of the server rules and community guidelines. I understand the importance of maintaining a safe, respectful, and inclusive environment for all members. I agree to follow all rules regarding content posting, communication standards, and community conduct.",
  },
  {
    q_index: 5,
    question: "Anything else we should know?",
    answer: "I'm a digital artist specializing in anthro character art and I've been doing commissions for about 2 years. I'm active in several other furry communities and conventions. I'm respectful of content boundaries and always happy to help newcomers feel welcome. Looking forward to being an active and positive member of the community!",
  },
];
